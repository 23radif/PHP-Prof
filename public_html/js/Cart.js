class Cart {
  ...
  _render() {
    let $totalGoods = $(`<a href="?act=checkout"><img src="img/cart.svg" alt="cart"><div class="cart-circle-five sum-goods"></div></a>`);
...
`);
  ...
  _init() {
    ...
    $('.href-checkout').click(event => {
      ...
      location.href = '?act=checkout';
    });
    $('.href-go-to-cart').click(event => {
      event.preventDefault();
      location.href = '?act=shopping_cart';
    });
...
`));
  ...
  _renderShoppingCart() {
    ...
    for (let product of this.cartItems) {
      ...
      let $productRowFirst = (`
        <a href="?act=product" class="product-row-first">
